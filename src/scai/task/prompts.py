...
TASK_PROMPTS: Dict[str, TaskPrompt] = {
    "task_prompt_1": TaskPrompt(
        ...
        assistant_connective="Please draft an article for me using less than {max_tokens} tokens. Please Note: Don't include a title or sections, just start writing a continuous piece of text with no whitespace between paragraphs.",
        content="""{task}""",
    ),
