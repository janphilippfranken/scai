...
utilities_dict_for_all={
    ...
    "selfish": " Be selfish when dealing with {currency}, meaning that you want to pragmatically gather the maximum benefit for yourself irrespective of how much benefit other people receive."}
