...
from scai.games.dictator_games.all_prompts.assistant.models import AssistantPrompt
from scai.games.dictator_games.all_prompts.task.models import TaskPrompt
...
from scai.games.dictator_games.all_prompts.user.user_prompt import task_connectives_for_all
