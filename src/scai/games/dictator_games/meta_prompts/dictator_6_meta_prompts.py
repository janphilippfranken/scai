...
Besides these sentences, include nothing else. The principle should be specific to different objects. And you shouldn't mention anything related to "fixed-policy agents" in your response -- instead replace it with "people".
"""
    ),
}