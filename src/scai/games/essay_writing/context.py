...
from scai.games.essay_writing.agents.user import UserModel
from scai.games.essay_writing.agents.assistant import AssistantAgent
from scai.games.essay_writing.agents.meta import MetaPromptModel
...
class Context():
    ...
    def run_turn(
        ...
        for assistant_model, assistant_prompt, user_model, user_prompt \
            ...
            self.buffer.save_agent_context(model_id=f"{assistant_model.model_id}_assistant", **assistant_response)
            ...
            # save user response
            self.buffer.save_agent_context(model_id=f"{user_model.model_id}_user", **user_response)
