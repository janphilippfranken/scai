...
DICTATOR_TASK_PROMPTS: Dict[str, TaskPrompt] = {
    "task_prompt_1": TaskPrompt(
        ...
        task="""You are the proposer. You will propose how to split the 10 dollars, and the person will accept or reject your proposal. Please only propose integer values. Most importantly, when proposing, follow your instructions with conviction. """,
