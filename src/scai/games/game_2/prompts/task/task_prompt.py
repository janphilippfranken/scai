...
DICTATOR_TASK_PROMPTS: Dict[str, TaskPrompt] = {
    "task_prompt_1": TaskPrompt(
        ...
        task="""You are the proposer. You will propose how to split the 10 dollars, and the person will accept or reject your proposal. Please only propose integer values. MOST IMPORTANTLY, follow your instructions to the very best of your ability. """,
...
DECIDER_TASK_PROMPTS: Dict[str, TaskPrompt] = {
    "task_prompt_1": TaskPrompt(
        ...
        user_connective="If you accept, you get the money proposed in the proposal. If you reject, you both get no money at all. Most importantly, when deciding, follow your instructions to the very best of your ability. Please answer in one word: accept or reject.",
        assistant_connective="If you accept, you get the money proposed in the proposal. If you reject, you both get no money at all. Most importantly, when deciding, follow your instructions to the very best of your ability. Please answer in one word: accept or reject.",
        content="""{task}""",
    ),
}