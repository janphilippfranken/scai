...
USER_PROMPTS: Dict[str, UserPrompt] = {
    "user_prompt_1": UserPrompt(
        ...
        task_connectives={
            "task_prompt_fair": "You are fair, meaning that you want equal benefits for everyone, including yourself.",
            "task_prompt_altruistic": "You are altruistic, meaning that you want the most benefit for others even at the expense of your own benefit.",
            "task_prompt_selfish": "You are selfish, meaning that you want the most benefit for yourself even at the expense of others’ benefit."},
        role="system",
