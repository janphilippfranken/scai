...
Revised Social Contract: <1. Social Contract Principle One. 2. Social Contract Principle Two, etc.  (Up to 15 principles with a max of {max_tokens_revision} words, all written in one line without breaks between principles).>""",
    ),
}
