...
Based on the above user feedback, revise the assistant's Developer Constitution and Social Contract to improve user experience:
...
Important: You MUST REVISE existing principles if the current principles are not optimal (i.e. not asll {subjective_metric} and {collective_metric} ratings 10 and user feedback is excellent). You can also remove principles if they are not relevant.
