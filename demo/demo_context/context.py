...
from demo_context.user import UserModel
from demo_context.assistant import AssistantAgent
from demo_context.meta import MetaPromptModel
...
class Context():
    ...
    def run_demo(
        ...
        save_path_1 = save_path + '/conversations'
        save_path_2 = save_path + '/constitutions'
